      ...
      <section className="py-16">
        ...
        <div className="flex flex-col gap-24">
          ...
          <div className="flex flex-row items-start justify-between">
            <div className="w-96 h-96 bg-gray-600 rounded-xl shrink-0 mr-12"></div>
          ...
          {/* 2 */}
          <div className="flex flex-row items-start justify-between">
            <div className="flex flex-col pr-12 justify-start max-w-xl">
              <div>
              ...
              <button className="mt-6 w-fit text-md text-white px-8 py-2 rounded-l-xl bg-indigo-500 hover:bg-indigo-400 transition duration-300 hover:shadow-md">
                Subscribe Now
              </button>
            </div>
            <div className="w-96 h-96 bg-gray-600 rounded-xl shrink-0"></div>
          </div>
