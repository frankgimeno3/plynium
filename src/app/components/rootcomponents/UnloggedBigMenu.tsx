    ...
    <div className="fixed top-14 mt-3 left-0 w-full h-full text-white z-50 flex">
      ...
      <div className="flex-[1] w-full flex flex-col items-center justify-center space-y-6 bg-zinc-900">
        ...
        <div
          ...
          onClick={() => handleRedirection('/en/media', 'media')}
          style={{ transitionDuration: '1200ms' }}
        >
          <p>Our media</p>
        </div>
          ...
          className={`text-xs md:text-lg hover:bg-zinc-500 hover:bg-opacity-70 pt-6 pb-5 px-3 text-center cursor-pointer w-full
             ${section === 'media' ? 'text-gray-500 bg-white' : 'opacity-50 hover:opacity-100'}`}
          onClick={() => handleRedirection('/en/agency', 'agency')}
          style={{ transitionDuration: '1200ms' }}
        >
          <p>Plynium Agency</p>
        </div>
          ...
          onClick={() => handleRedirection('/en/newsroom', 'newsroom')}
          style={{ transitionDuration: '1200ms' }}
        >
          <p>Newsroom</p>
        </div>
        <div
          className={`text-xs md:text-lg hover:bg-zinc-500 hover:bg-opacity-70 pt-6 pb-5 px-3 text-center cursor-pointer w-full
             ${section === 'login' ? 'text-gray-500 bg-white' : 'opacity-50 hover:opacity-100'}`}
          onClick={() => handleRedirection('/en/auth/login', 'login')}
          style={{ transitionDuration: '1200ms' }}
        >
          <p>Log in</p>
                  </div>
                <div
          className={`text-xs md:text-lg hover:bg-zinc-500 hover:bg-opacity-70 pt-6 pb-5 px-3 text-center cursor-pointer w-full
             ${section === 'register' ? 'text-gray-500 bg-white' : 'opacity-50 hover:opacity-100'}`}
          onClick={() => handleRedirection('/en/auth/register', 'register')}
          style={{ transitionDuration: '1200ms' }}
        >
...
export default UnloggedBigMenu;
